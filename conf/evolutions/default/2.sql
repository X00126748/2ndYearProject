...
insert into product (id,name,description,stock,price,supplier_id, amount_sold, rating) values ( 1,'Nike T-Shirt','Mens Black Basketball Top',50,40.00, 1 ,0,4.0);
insert into product (id,name,description,stock,price,supplier_id, amount_sold, rating) values ( 2,'Nike T-Shirt','Mens Bring Your Game Basketball Top',50,35.00, 1 ,0,4.5);
insert into product (id,name,description,stock,price,supplier_id, amount_sold, rating) values ( 3,'Nike T-Shirt','Mens Black & White Basketball Top',50,35.00, 1 ,0,4.0);
insert into product (id,name,description,stock,price,supplier_id, amount_sold, rating) values ( 4,'Nike T-Shirt','Good Things Come In Threes Top',50,40.00, 1 ,0,5.0);
insert into product (id,name,description,stock,price,supplier_id, amount_sold, rating) values ( 5,'Nike T-Shirt','Kobe Bryant Black Top',50,26.00, 1 ,0,4.0);
insert into product (id,name,description,stock,price,supplier_id, amount_sold, rating) values ( 6,'Nike T-Shirt','Kobe Bryant Grey Top',50,30.00 , 1,0,4.0);
insert into product (id,name,description,stock,price,supplier_id, amount_sold, rating) values ( 7,'Nike T-Shirt','Lebron James Grey Top',50,35.00, 1 ,0,4.0);
insert into product (id,name,description,stock,price,supplier_id, amount_sold, rating) values ( 8,'Jordan T-Shirt','Air Jordan Gret Top',50,26.00, 1 ,0,3.0);
insert into product (id,name,description,stock,price,supplier_id, amount_sold, rating) values ( 9,'Jordan T-Shirt','Air Jordan Black Top',50,30.00, 1 ,0,5.0);
insert into product (id,name,description,stock,price,supplier_id, amount_sold, rating) values ( 10,'Jordan T-Shirt','Air Jordan Engineered For Flight Top',50,35.00 , 1,0,4.5);
insert into product (id,name,description,stock,price,supplier_id, amount_sold, rating) values ( 11,'Jordan T-Shirt','Air Jordan Long Sleeve Top',50,45.00, 1 ,0, 3.5);
insert into product (id,name,description,stock,price,supplier_id, amount_sold, rating) values ( 12,'Jordan T-Shirt','Air Jordan No Excuses Top',50,30.00,1 ,0 ,5);
insert into product (id,name,description,stock,price,supplier_id, amount_sold, rating) values ( 13,'Jordan T-Shirt','Air Jordan No Excuses Top',5,30.00, 1 ,0,0);
insert into product (id,name,description,stock,price,supplier_id, amount_sold, rating) values ( 14,'Jordan T-Shirt','Air Jordan No Excuses Top',5,30.00, 1 ,0,0);
insert into product (id,name,description,stock,price,supplier_id, amount_sold, rating) values ( 15,'Jordan T-Shirt','Air Jordan No Excuses Top',5,30.00, 1 ,0,0);
insert into product (id,name,description,stock,price,supplier_id, amount_sold, rating) values ( 16,'Jordan T-Shirt','Air Jordan No Excuses Top',5,30.00, 1 ,0,0);
